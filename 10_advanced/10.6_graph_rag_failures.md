...
"iPhone 15是苹果公司2023年推出的智能手机，
 采用 A16 Bionic 芯片，配备 6.1 英寸 Super Retina XDR 显示屏，
 支持 Dynamic Island，是 iPhone 14的升级版本。"
...
Entities:
  ...
  - 苹果公司 (公司)
  - A16 Bionic 芯片 (零件)
  - Super Retina XDR 显示屏 (特性)
  - Dynamic Island (特性)
  - iPhone 14 (产品)

问题分析：
1. "Super Retina XDR 显示屏"和"Dynamic Island"不应该作为独立产品实体，应该是属性
...
某个 500K 文档的知识库（使用 Claude 的当前高性能档位）：
- 初始构建：1000万个 LLM调用 = $30K （平均 $3/1M tokens）
- 月度更新：200万个 LLM调用 = $6K
- 查询时（100K月查询）：可能需要额外 100万调用 = $3K/月
...
Graph RAG额外成本 = $30K初始 + $3K×12月 = $66K/年
```
