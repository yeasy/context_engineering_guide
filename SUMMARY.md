...
* [第十三章：行业应用案例](13_cases/README.md)
  ...
  * [13.5 案例分析：Manus AI 的全自主智能体架构](13_cases/13.5_generalist_agent.md)
  * [本章小结](13_cases/summary.md)

* [第十四章：综合实战 - 构建具备长期记忆的智能研发助手](14_practice/README.md)
  * [14.1 项目需求：从问答到 Copilot](14_practice/14.1_requirements.md)
  * [14.2 记忆系统设计：短期与长期记忆融合](14_practice/14.2_memory_architecture.md)
  * [14.3 当前状态感知：工具链与 IDE 上下文集成](14_practice/14.3_ide_integration.md)
  * [14.4 动态规划：任务拆解与上下文更新](14_practice/14.4_dynamic_planning.md)
  * [14.5 从检索到行动：Code Interpreter 的应用](14_practice/14.5_action_execution.md)
  * [14.6 持续优化与评估](14_practice/14.6_optimization.md)
