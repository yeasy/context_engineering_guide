...
实验代码位于 [`examples/enterprise_know/`](../examples/enterprise_know/README.md)，其中 `sample_docs/` 展示了带部门权限元数据的知识库文档。真实系统可以替换为 PDF/Office 解析器、领域嵌入模型和持久化向量库，但应保留来源、权限、版本和分块参数等元数据。
