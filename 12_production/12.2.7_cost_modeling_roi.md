## 12.2.7 成本建模与 ROI 分析框架

### 12.2.7.1 引言：为什么需要成本建模
...
optimized = {
    ...
    'avg_output_tokens': 300,
    'monthly_api_cost': 2200,  # 成本下降 51%（4500→2200）
    'avg_response_time_ms': 800,  # 响应时间快约 73%（3000→800ms）
