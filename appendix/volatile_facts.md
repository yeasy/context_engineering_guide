...
> Last verified: 2026-06-09. 本表约束上下文窗口、模型价格、协议、RAG/Agent runtime 等高波动事实；模型上下文窗口口径与第 2.4 节的官方快照同步。

| 类别 | 当前维护口径 | 权威入口 | 编辑要求 |
| --- | --- | --- | --- |
| 模型上下文窗口 | OpenAI、Claude（2026-06-09 起含 Fable 5 / Mythos 5 新一代）、Gemini、Llama、DeepSeek 等上下文窗口只写 dated snapshot。 | [OpenAI Models](https://developers.openai.com/api/docs/models/all/), [Claude Models](https://platform.claude.com/docs/en/about-claude/models/overview), [Gemini Models](https://ai.google.dev/gemini-api/docs/models) | 正文应强调设计策略，具体窗口放表格并标日期；“最强/旗舰”须区分 Fable 5（全系）与 Opus 4.8（Opus 档）。 |
