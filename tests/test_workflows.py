...
UPLOAD_RELEASE = [
    "release", "upload", "preview-pdf", "dist/context_engineering_guide.pdf",
    "dist/context_engineering_guide.html", "dist/SHA256SUMS", "--clobber",
]
...
upload_release = ["release", "upload", "preview-pdf", "dist/context_engineering_guide.pdf", "dist/context_engineering_guide.html", "dist/SHA256SUMS", "--clobber"]
